...
| Documento | Relación |
|---|---|
| `docs/DOCUMENTATION_ARCHITECTURE.md` | Define tipos, dominios, propiedad, relaciones y ciclo de vida del conocimiento. |
| `docs/README.md` | Portal de navegación y mapa operativo de la documentación. |
| `docs/project/DECISION_LOG.md` | Registro transversal de decisiones que no pertenecen únicamente a un documento específico. |
| `docs/standards/STD-GLOSARIO.md` | Terminología oficial del producto. |
| `docs/ai/AI_COLLABORATION_GUIDE.md` | Instrucciones generales de colaboración con IA. |
...
La sección `DECISIÓN` facilita saber si el documento fue aprobado, qué sigue y cuál es su impacto dentro de una fase de trabajo.

### 14.2. Uso

Se recomienda en:

- candidatos para aprobación;
- documentos fundacionales;
- arquitecturas;
- estándares;
- entregables de consolidación.

No es obligatoria en todo documento operativo.
...
### 14.4. Diferencia con el estado documental

- El **estado documental** indica vigencia y madurez.
- La **decisión de cierre** comunica el resultado de la revisión actual y el siguiente paso.
...
Si en el futuro existe `docs/history/`, su traslado seguirá las reglas de Arquitectura Documental.
...
- [ ] Fue revisado por los arquitectos del producto.
- [ ] Su estado y versión coinciden con la decisión.
...
1. todo documento nuevo aplicará este estándar;
2. `ADN_ACADEMIA_GLORIA_VALENTINA.md` será el primer documento existente evolucionado con conformidad completa;
3. `docs/README.md` se actualizará después para reflejar arquitectura, estándar y rutas vigentes;
4. el resto se alineará progresivamente al ser revisado;
5. se podrá planificar una jornada de actualización documental con alcance controlado.
...
**Estado:** 🟢 Aprobado  
**Próximo paso:** Crear `docs/project/PROJECT_ROLES.md` y aplicar este estándar a los próximos entregables.  
**Impacto:** Documentación Oficial · Gobierno del Conocimiento · Calidad Documental · Continuidad del Producto
